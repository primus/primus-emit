...
[![Build Status](https://travis-ci.org/primus/emit.svg?branch=master)](https://travis-ci.org/primus/emit)
[![NPM version](https://badge.fury.io/js/primus-emit.svg)](http://badge.fury.io/js/primus-emit)
